...
Durante o desenvolvimento foram utilizados diversos conceitos de HTML e CSS, como:
...
- `CSS Variables`
- `clamp()`
- Unidades responsivas (`%`, `rem`, `vw`, `vh`)
- Layout responsivo
- Menu hamburger utilizando apenas HTML e CSS
